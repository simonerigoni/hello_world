...
\begin{entrylist}
	...
	\entry
		...
		%Performances are a key aspect of my work because of the high volume of data used by these business process. I %have been involved also in the recruiting phase for the technical interviews and in the tutoring of new hires
		}
		{}
		{}
		%\texttt{T-SQL}\slashsep\texttt{VBA}\slashsep\texttt{MDX}\slashsep\texttt{MDX}}
...
%		{Tutoring my fellow students of the college about Computer Science and C programming}
%		{}
%		{}
	\entry
		{03/2016 -- 06/2016}
		...
		%, so that it could download updates from remote servers and reprogram itself. 
